...
const IngresoAlmacen = ({ listaKardex, ListarMovimientos }) => {
    const { Option } = Select
    ...
    const IngresarMateriales = async (values) => {
        ...
        const { success } = await registrarIngresoMaterial(nuevoMaterial)
                    ...
                    <Row justify="center">
                        ...
                        <Col md={6}>
                            <Form.Item
                                ...
                                rules={[{ required: true, message: 'falta el codigo de documento' }]}
                            >
